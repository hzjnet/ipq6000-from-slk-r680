...
if found_sta then
	...
	radio_ch = s:taboption("general", ListValue, "channel", translate("Channel"))
	radio_ch:value("auto", translate("auto"))
	for _, freq in ipairs(iw.freqlist) do
		radio_ch:value(freq.channel, freq.channel .. " (%d MHz)" % freq.mhz)
	end

	radio_hw = s:taboption("general", ListValue, "hwmode", translate("Mode"))
	radio_ht = s:taboption("general", ListValue, "htmode", translate("Width"))
	if hw_modes.ac then
		radio_hw:value("11axa", "11axa")
		radio_hw:value("11ac", "11ac")
		radio_hw:value("11na", "11na")
		radio_hw:value("11a", "11a")

		radio_ht:value("auto", "auto")
		radio_ht:value("HT80", "HT80")
		radio_ht:value("HT40", "HT40")
		radio_ht:value("HT20", "HT20")
	else
		radio_hw:value("11axg", "11axg")
		radio_hw:value("11ng", "11ng")
		radio_hw:value("11bg", "11bg")
		radio_hw:value("11b", "11b")
